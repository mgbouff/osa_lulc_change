...
links_87_98$IDsource <- match(links$source, nodes$name)-1
links_87_98$IDtarget <- match(links$target, nodes$name)-1
...
# With networkD3, connection must be provided using id, not using real name like in the links dataframe.. So we need to reformat it.
links_98_19$IDsource <- match(links$source, nodes$name)-1
links_98_19$IDtarget <- match(links$target, nodes$name)-1
