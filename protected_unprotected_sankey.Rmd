...
# Protected Areas
#---------------------------------------
pa_transition_long$node <- factor(pa_transition_long$node, levels =  c("Forest", "Exposed Soil/Urban", "Grassland/Pasture", "Mangrove", "Palm", "Teak/Gmelina", "Water", "Wetland"))

# Non Protected Areas
#---------------------------------------
nonpa_transition_long$node <- factor(nonpa_transition_long$node, levels =  c("Forest", "Exposed Soil/Urban", "Grassland/Pasture", "Mangrove", "Palm", "Teak/Gmelina", "Water", "Wetland"))
...
# Save
# ggsave(here("Images", "nonprotectedareas_transition_sankey.jpeg"), nonpa_transition_plot, width = 7.5, height = 4)
...
# Protected Areas
#---------------------------------------
pa_changeonly_long$node <- factor(pa_changeonly_long$node, levels =  c("Forest", "Exposed Soil/Urban", "Grassland/Pasture", "Mangrove", "Palm", "Teak/Gmelina", "Water", "Wetland"))

# Non Protected Areas
#---------------------------------------
nonpa_changeonly_long$node <- factor(nonpa_changeonly_long$node, levels =  c("Forest", "Exposed Soil/Urban", "Grassland/Pasture", "Mangrove", "Palm", "Teak/Gmelina", "Water", "Wetland"))
...
ggsave(here("Images", "graphicalabstract_patchwork_changeonly.jpeg"), changeonly_patchwork, width = 8.5, height = 5)
